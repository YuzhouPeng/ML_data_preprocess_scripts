...
# 训练过的模型路径
resume_path = "/home/pengyuzhou/workspace/pytorch-train/11.24_chipfault2_torch1.4_se_resnext_optim_112_labelsmooth_4_epoch_150.pt"
# 输入图像路径
single_img_path = 'TJU\GBDB\set113\CAM\temp.jpg'
# 绘制的热力图存储路径
save_path = 'TJU\GBDB\set113\CAM\temp_layer4.jpg'
