...
# Add binary masks to images
    for img_item in os.listdir(images_path):
        ...
        mask_path = os.path.join(masks_path, img_item)  # mask是.png格式的，image是.jpg格式的
...
images_path = '/home/pengyuzhou/workspace/safty_belt11_resize_seg/val/wear'
masks_path = '/home/pengyuzhou/workspace/safty_belt11_resize_seg_mask/val/wear'
masked_path = '/home/pengyuzhou/workspace/safty_belt11_resize_seg_result/val/wear'
