...
# Add binary masks to images
  for img_item in os.listdir(images_path):
    ...
    mask = cv2.imread(mask_path, cv2.IMREAD_GREYSCALE) # 将彩色mask以二值图像形式读取
...
images_path = '/home/pengyuzhou/workspace/fire_path_origin/not_occupied'
masks_path = '/home/pengyuzhou/workspace/fire_path_mask/not_occupy_filter_res'
masked_path = '/home/pengyuzhou/workspace/fire_path_cutout/not_occupy'
